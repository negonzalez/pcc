...
# ESO/DFS
#
# "@(#) $Id: PccUtTime.py,v 1.3 2012/05/25 11:29:56 amanning Exp $"
#
# Who       When        What
# --------  ----------  -------------------------------------------------------
...
class TimeStamp:
    ...
    def getTimeStamp(self):
        ...
        # previously: secs = "%.3f % timeTuplue[1]
        # but if the secs was e.g. 59.9997
        # the output would be 60
        # now we truncate after 3 decimal digits before formatting the output
        secs = "%.3f" % (int(timeTuple[1] * 1000) / 1000.0)
